...
public class Errors {
    ...
    public static final String INVALID_MANUAL_LOTTO_COUNT = "수동으로 구매한 로또 개수가 구매할 수 있는 로또 개수보다 클 순 없습니다.";
    public static final String MANUAL_LOTTO_COUNT_IS_NEGATIVE = "수동으로 구매한 로또 개수는 음수일 수 없습니다.";
}
