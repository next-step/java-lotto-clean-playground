...
public abstract class ProfitCalculator {
    ...
    public static double calculateProfitRate(Map<LottoRank, Integer> resultByRank, LottoCount lottoCount) {
        ...
        return totalPrize.getAmount() / (lottoCount.getLottoCount() * PRICE_PER_TICKET);
    }
