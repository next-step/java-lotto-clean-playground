...
class LottoTicketsTest {
    ...
    void return_CorrectMatchCount_Map_compare_With_WinningNumbers() {
        ...
        // When
        Map<Integer, Integer> results = lottoTickets.countMatchResults(winningNumbers);

        // Then
        assertThat(results.get(6)).isEqualTo(1); // 6개 일치한 건 1개
        assertThat(results.get(3)).isEqualTo(1); // 3개 일치한 건 1개
        assertThat(results.getOrDefault(0, 0)).isEqualTo(1); // 0개 일치한 건 1개
    }
}
