...
//        );
//
//        LottoList lottoPurchase = new LottoList(purchaseAmount, manualLottos, generatorFactory);
//
...
//
//        assertThatThrownBy(() -> new LottoList(purchaseAmount, List.of(), generatorFactory))
