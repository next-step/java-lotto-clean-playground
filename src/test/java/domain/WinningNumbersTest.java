...
public class WinningNumbersTest {
  ...
  void test_당첨번호와_일치하는_개수_계산() {
    assertAll(
        () -> assertEquals(6L, winningNumbers.matchCount(new Lotto(List.of(1, 2, 3, 4, 5, 6)))),
        () -> assertEquals(3L, winningNumbers.matchCount(new Lotto(List.of(1, 2, 3, 7, 8, 9)))),
        () -> assertEquals(0L, winningNumbers.matchCount(new Lotto(List.of(7, 8, 9, 10, 11, 12))))
    );
  }
