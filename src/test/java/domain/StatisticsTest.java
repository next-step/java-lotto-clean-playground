...
class StatisticsTest {
    ...
    void 처음_생성된_통계는_0으로_초기화되어있다(){
        ...
        for (Prize prize : Prize.values()){
            assertEquals(0, matchCounts.get(prize), "초기 카운트는 0이어야합니다.");
        }
    }
    ...
    void 수익률_계산_정확성_테스트(){
        ...
        statistics.matchCountUpdate(5, false);
        statistics.matchCountUpdate(4, false);
        statistics.matchCountUpdate(3, false);// 상황 가정
