...
public class NumberPoolTest {
    ...
    void from은_to보다_클_수_없다() {
        assertThrows(IllegalArgumentException.class, () -> NumberPool.of(2, 1));
    }

    @Test
    void 범위의_크기는_LOTTO_SIZE보다_커야_한다() {
        assertThrows(IllegalArgumentException.class, () -> NumberPool.of(Lotto.LOTTO_NUMBER_MIN, Lotto.LOTTO_NUMBER_MIN + Lotto.LOTTO_SIZE - 2));
    }
}
