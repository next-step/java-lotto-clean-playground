...
@DisplayName("model.domain.Lotto 클래스 테스트")
...
public class LottoTest {
    private static Stream<Arguments> provideLottoNumbersAndExpectedMatchCount() {
        return Stream.of(
                ...
                Arguments.of(Arrays.asList(10, 11, 12, 13, 14, 15), Arrays.asList(1, 2, 3, 4, 5, 6), 0)
        );
    }
    ...
    void countMatches_호출_시_일치하는_번호의_개수를_정확히_반환한다(
            List<Integer> userNumbers, List<Integer> winningNumbers, int expectedCount) {
