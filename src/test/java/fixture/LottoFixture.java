...
public class LottoFixture {
    ...
    public static final List<LottoNumber> testLottoNumbersOneToSix = testNumbersOneToSix.stream().map(LottoNumber::new).toList();
    public static final List<LottoNumber> testLottoNumbersSevenToTwelve = testNumbersSevenToTwelve.stream().map(LottoNumber::new).toList();
    public static final List<LottoNumber> testLottoNumbersFortyToFortyFive = testNumbersFortyToFortyFive.stream().map(LottoNumber::new).toList();
